    ...
    Modules.prototype.create = function(module, args, register, useChildInjector) {
        ...
        var moduleInstance;
        var moduleClass;
        var shouldRegister = register === false ? false : true;
        var shouldUseChildInjector = useChildInjector === true ? true : false;
        ...
        function instantiate(injector, value, args) {
            ...
            var params = infuse.getDependencies(value);

            // add module function
            var moduleArgs = [value];
            ...
            // trim array
            for (var a = moduleArgs.length-1; a >= 0; a--) {
        ...
        if (moduleClass) {
            if (this.has(moduleClass.id)) {
                ...
                var injectorTarget = this.injector;
